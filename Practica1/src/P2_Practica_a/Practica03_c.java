...
public class Practica03_c extends JFrame implements ActionListener {
	...
	// declaracion de los objetos de los controladores 
	...
	public Practica03_c() {
		super ("Administracion de prodcutos");
		//inicializamos las lista para el manejo de datos 
		...
		ComboCategoria.addActionListener((ActionListener) this);
